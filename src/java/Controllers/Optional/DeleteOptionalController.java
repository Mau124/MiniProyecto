 ...
 * @author Andres
 */
@WebServlet(name = "DeleteOptionalController", urlPatterns = {"/DeleteOptionalController"})
public class DeleteOptionalController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (optional.deleteOptional(IDOptional))
            {
                result = true;
            } else 
            {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Eliminar materia opcional</title>");  
