 ...
 * @author 52333
 */
@WebServlet(urlPatterns = {"/DeleteTeacherController"})
...
private boolean result;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Eliminar maestro</title>");  
    ...
    try {
        ...
        Logger.getLogger(DeleteTeacherController.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
